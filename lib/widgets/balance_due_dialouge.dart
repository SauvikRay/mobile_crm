...
class BalanceDueDialoge extends StatefulWidget {
  const BalanceDueDialoge({Key? key}) : super(key: key);

  @override
  State<BalanceDueDialoge> createState() => _BalanceDueDialogeState();
}

class _BalanceDueDialogeState extends State<BalanceDueDialoge> {
